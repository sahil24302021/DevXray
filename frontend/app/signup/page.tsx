      ...
      <div className="relative z-10 w-full max-w-sm px-4">
        <div className="bg-[#0a0a0a] border border-[#222] rounded-2xl p-8 shadow-2xl">
          <div className="text-center mb-8">
            ...
            <p className="text-[#666] text-sm">Free forever. No credit card needed.</p>
          </div>
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-[#0a0a0a] px-3 text-[#555]">or sign up with email</span>
            </div>
          </div>
          ...
          <p className="text-center text-[#555] text-sm mt-6">
            ...
            <Link href="/signin" className="text-[#cdff00] hover:underline">
              Sign in
            </Link>
          </p>
        </div>
